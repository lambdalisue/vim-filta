...
execute join(['function! vital#_filta#Vim#Buffer#Writer#import() abort', printf("return map({'replace': '', '_vital_created': '', '_vital_healthcheck': '', 'new': ''}, \"vital#_filta#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
